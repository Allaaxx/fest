    ...
    return (
      <div className="flex gap-2 bg-white border rounded shadow p-2 mb-2 sticky top-0 z-10">
        ...
        <button
          type="button"
          className={
            editor.isActive("underline") ? "underline text-[#f0739f]" : ""
          }
        ...
        <button
          type="button"
          className={
            editor.isActive("strike") ? "line-through text-[#f0739f]" : ""
          }
        ...
        <button
          type="button"
          className={
            editor.isActive({ textAlign: "left" }) ? "text-[#f0739f]" : ""
          }
        ...
        <button
          type="button"
          className={
            editor.isActive({ textAlign: "center" }) ? "text-[#f0739f]" : ""
          }
        ...
        <button
          type="button"
          className={
            editor.isActive({ textAlign: "right" }) ? "text-[#f0739f]" : ""
          }
      ...
      <div className="shadow-lg p-4 bg-white rounded-lg flex flex-col">
        ...
        <div className="mt-5 flex flex-col gap-4">
          ...
          <div className="mb-1 px-4">
            {productData.type === "venda" && (
              <>
                <h5 className="w-full font-light text-[#051922]">
                  Quantidade:
                </h5>
                <Input
        ...
        <div className="mb-5 flex items-center justify-start px-3 gap-4 flex-wrap">
          ...
          <div className="flex items-center gap-1 text-black">
            <CheckSquare
              className={`w-5 h-5 ${productData.availability ? "text-black" : "text-gray-400"}`}
            />
            <h6
              className={`m-0 text-lg font-bold ${productData.availability ? "text-black" : "text-gray-400"}`}
            >
              <Select
        ...
        <div className="gap-4 px-3">
          <label className="block text-[#051922] font-semibold mb-1">
            Características
          </label>
          ...
          <div className="flex gap-6 mt-4">
            <div className="flex items-center space-x-2">
              ...
              <label
                htmlFor="delivery"
                className="text-sm text-[#051922] cursor-pointer"
              >
                Entrega disponível
              </label>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mt-4">
              {productData.images.map((image: File, index: number) => (
                <div key={index} className="relative group">
                  ...
                  {index === 0 && (
                    <Badge className="absolute bottom-2 left-2 bg-[#f0739f] text-white text-xs">
                      Principal
                    </Badge>
                  )}
                </div>
