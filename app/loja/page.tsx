                  ...
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => {
                      if (checked) {
                        ...
                        setSelectedTypes(selectedTypes.filter((t) => t !== "venda"))
                      }
                    }}
                  />
                  ...
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => {
                      if (checked) {
                        ...
                        setSelectedTypes(selectedTypes.filter((t) => t !== "locacao"))
                      }
                    }}
                  />
                      ...
                      <div className="flex-1">
                        <div className="flex justify-between items-start">
                          ...
                          <div className="text-right">
                            ...
                            >
                              <Heart
                                className={`h-4 w-4 ${isInWishlist(product.id.toString()) ? "fill-current" : ""}`}
                              />
                            </Button>
                            <div className="mt-2">
                              <span className="text-lg font-bold text-fest-primary">R$ {product.price.toFixed(2)}</span>
