...
export default function LoginPage() {
  ...
  useEffect(() => {
    if (status === "authenticated") {
      ...
      else if (role === "VENDEDOR") router.replace("/vendedor/dashboard");
      ...
      <div className="auth-container  relative z-10">
        ...
        >
          <form action="#" className="z-30" onSubmit={handleSubmit}>
            ...
            <div className="forgot-link">
              <a href="/recuperar-senha" className="text-pink-500 hover:underline">Esqueceu a senha?</a>
            </div>
            <button
              type="submit"
        ...
        >
          <form className="w-full max-w-md" onSubmit={handleRegister}>
            ...
            <button
              type="submit"
              className="w-full h-12 bg-pink-500 hover:bg-pink-600 text-white font-medium rounded-lg transition-colors flex items-center justify-center"
              disabled={isLoading}
            >
              {isLoading ? (
                <span className="flex items-center">
